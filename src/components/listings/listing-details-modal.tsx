                ...
                <div className="grid lg:grid-cols-[1.08fr_0.92fr]">
                    ...
                    <div className="p-6 sm:p-8">
                        ...
                        <div className="mt-5 rounded-[1.4rem] border border-stone-200 bg-white/90 p-5 shadow-[0_10px_24px_rgba(15,23,42,0.04)]">
                            ...
                            <strong className="font-display mt-2 block text-4xl leading-none text-[#b54f32]">{formatListingPrice(listing)}</strong>
                        </div>

                        <p className="mt-5 text-base leading-7 text-slate-700">{listing.shortDescription}</p>
                        ...
                        {listing.galleryImages.length > 1 ? (
                            <div className="mt-6 rounded-[1.5rem] border border-stone-200 bg-white p-5">
                                ...
                                <div className="mt-4 grid grid-cols-3 gap-3">
                                    {listing.galleryImages.slice(0, 6).map((image) => (
                                        <img
                                            key={image}
                                            src={image}
                                            alt={listing.title}
