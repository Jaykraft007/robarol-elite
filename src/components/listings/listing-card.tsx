        ...
        >
            ...
            {isCompact ? (
                <div className="flex flex-1 flex-col p-3.5 sm:p-4">
                    ...
                    <p className="mt-2 hidden text-[13px] leading-6 text-slate-600 sm:block">{listing.shortDescription}</p>

                    <div className="mt-3 grid grid-cols-2 gap-2 sm:mt-4 sm:gap-2.5">
                        {detailItems.slice(0, 2).map((detail) => (
                ...
                <div className="flex flex-1 flex-col p-4 sm:p-5">
                    ...
                    <p className="mt-3 line-clamp-2 text-[13px] leading-5 text-slate-600 sm:mt-4 sm:text-sm sm:leading-6.5">{listing.shortDescription}</p>

                    <div className="mt-3 grid grid-cols-2 gap-2 sm:mt-4 sm:gap-2.5">
                        {detailItems.slice(0, 4).map((detail, index) => (
                            <div
