...
export function AdminListingCard({ listing, onView, onDelete, onStatusChange }: AdminListingCardProps) {
    ...
    return (
        <article className="rounded-[1.55rem] border border-stone-200 bg-white p-4 shadow-[0_12px_34px_rgba(15,23,42,0.06)]">
            <div className="flex gap-3">
                <img
                    src={listing.mainImage}
                    alt={listing.title}
                    className="h-24 w-24 rounded-[1.15rem] object-cover"
                />
            ...
            <p className="mt-4 text-sm leading-6 text-slate-600">{listing.shortDescription}</p>
