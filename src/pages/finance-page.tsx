        ...
        <>
            ...
            <section className="pb-10 pt-4 sm:pb-16 sm:pt-6">
                <div className="mx-auto grid w-[min(1200px,calc(100%-1rem))] gap-4 sm:w-[min(1200px,calc(100%-1.5rem))] sm:gap-5 md:grid-cols-3">
                    {[
                        ["Vehicle Purchase", "For buyers acquiring a car or SUV."],
                        ["Yacht Purchase", "For clients planning a marine acquisition."],
                        ["Property Brief", "For property buyers starting a direct conversation."]
                    ].map(([title, text]) => (
