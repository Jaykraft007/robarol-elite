...
export function AdminListingsPage() {
    const { allListings, deleteListing, updateListingStatus } = useSiteData();
                ...
                <div className="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
                    <div>
                        ...
                        <p className="mt-2 text-sm leading-6 text-slate-600">
                            Manage cars, yachts and properties shown on the website.
                        </p>
                    </div>
                ...
                {filteredListings.length > 0 ? (
                    ...
                    <div className="rounded-[1.7rem] border border-stone-200 bg-white px-5 py-10 text-center shadow-[0_14px_40px_rgba(15,23,42,0.06)] sm:px-6">
                        ...
                        <p className="mx-auto mt-3 max-w-lg text-sm leading-7 text-slate-600">
                            {hasListings
                                ? "Adjust search, category or status to continue."
                                : "Add your first car, yacht or property to begin."}
                        </p>
                        {!hasListings ? (
                            <NavLink
                                to="/admin/listings/new"
