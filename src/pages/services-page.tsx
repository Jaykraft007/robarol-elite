            ...
            <section className="pb-10 pt-4 sm:pb-16 sm:pt-6">
                <div className="mx-auto grid w-[min(1200px,calc(100%-1rem))] gap-4 sm:w-[min(1200px,calc(100%-1.5rem))] sm:gap-5 md:grid-cols-2 xl:grid-cols-4">
                    {[
                        ...
                        ["Business Development", "Business consulting and support around commercial opportunities."],
                        ["Finance & Loans", "Finance support for home, business, personal, car and yacht loans."],
                        ["Visa & PR Support", "Visa for foreigners, employment passes, PR application and business setup support."]
                    ].map(([title, text]) => (
