                ...
                <table className="min-w-full border-collapse text-left">
                    ...
                    <tbody>
                        {listings.map((listing) => {
                            ...
                            return (
                                <tr key={listing.id} className="border-b border-stone-200/80 align-top transition hover:bg-stone-50/55 last:border-b-0">
                                    ...
                                    <td className="px-5 py-4">
                                        <div className="min-w-[16rem]">
                                            ...
                                            <p className="mt-1 line-clamp-2 max-w-md text-sm leading-6 text-slate-600">{listing.shortDescription}</p>
